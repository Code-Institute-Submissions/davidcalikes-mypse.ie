...
Before this project, I had successfully developed other applications using the traditional, 'Waterfall' methodology, which is a more direct, individualised, approach to project management.
