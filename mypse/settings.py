"""
Django settings for mypse project.
...
# Clickjacking prevention etting:
# Page can only be embedded in a page frame with the same origin as itself.
...
WSGI_APPLICATION = 'mypse.wsgi.application'
